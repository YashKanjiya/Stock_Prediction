...
# def update_data(stock_total,stock_pre_total,stock_profit):
# 	c.execute('UPDATE stockprofit SET (Total_inverment,Total_Pvalue,Total_Profit)',(stock_total,stock_pre_total,stock_profit))
# 	conn.commit()

# def viewprofit():
# 	c.execute('select * from stocktotal')
# 	return c.fetchall()
